...
def data_over_time(df, col):
    ...
    nations_over_time.columns = ['Year', 'Count']  # Rename columns explicitly
...
def most_successful(df, sport):
    ...
    # Get value counts and explicitly name columns
    name_counts = temp_df['Name'].value_counts().reset_index()
    name_counts.columns = ['Name', 'Medal_Count']
    
    # Merge and select columns
    x = name_counts.head(15).merge(df, left_on='Name', right_on='Name', how='left')[
